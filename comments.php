<div class="eltd-comment-holder clearfix" id="vk_comments" style="width:100%;margin:20px 0;"></div>
...
jQuery(function($)
{
    ...
    {
        var wh = $('#vk_comments').parent().width()*0.85;
        $('#vk_comments').css('width', wh);
        $('#vk_comments iframe').css('width', wh);
    });
